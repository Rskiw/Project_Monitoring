...
$prog = $_POST['prog'];
mysqli_query($koneksi,"insert into mon (No, project_name, client, gambar, nama, email, start_date, end_date, progress) Values ('','$Pname','$client','$gambar','$nama','$email','$Sdate','$Edate','$prog')");
